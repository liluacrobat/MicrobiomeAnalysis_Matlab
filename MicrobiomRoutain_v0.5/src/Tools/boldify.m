...
if ~isempty(hTexts)
  ...
  for ii = 1:length(hTexts)
    hText = hTexts(ii);
    set(hText,'FontSize',newSizes(ii))
...
if nAxes
  ...
  set(hAxes,'Units','normalized','FontSize',fontSize,...
	    'LineWidth',1)
  ...
  set(hTitles,'FontSize',(8/7)*fontSize)

  hXLabels = cellcat(get(hAxes,'XLabel'));
  set(hXLabels,'FontSize',(8/7)*fontSize,...
	       'VerticalAlignment','top')

  hYLabels = cellcat(get(hAxes,'YLabel'));
  set(hYLabels,'FontSize',(8/7)*fontSize,...
	       'VerticalAlignment','baseline')

  hZLabels = cellcat(get(hAxes,'ZLabel'));
  set(hZLabels,'FontSize',(8/7)*fontSize,...
	       'VerticalAlignment','baseline')
end
